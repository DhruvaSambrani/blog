...
* **.Calibre Web Advanced**: [Calibre Web Automated](https://github.com/crocodilestick/Calibre-Web-Automated) - self hosted library **Book-Downloader** - [calibre-web-automated-book-downloader](https://github.com/calibrain/calibre-web-automated-book-downloader) - Books downloaded from sources for CWA to ingest.
* CopyParty - [CopyParty](https://github.com/9001/copyparty) - File uploader
* YT-DLP Web UI - [YT-DLP Webui](https://github.com/marcopiovanello/yt-dlp-web-ui) - Download Youtube music.
* Jellyfin - [Jellyfin](https://jellyfin.org/) - Media server
